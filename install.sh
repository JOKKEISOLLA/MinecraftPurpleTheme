...
installTheme(){
    ...
    git clone https://github.com/JOKKEISOLLA/MinecraftPurpleTheme.git
...
repair(){
    bash <(curl https://raw.githubusercontent.com/JOKKEISOLLA/MinecraftPurpleTheme/main/repair.sh)
}
